 ...
 * Use the [SigninCreateAccountFragment.newInstance] factory method to
...
class SigninCreateAccountFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SigninCreateAccountFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SigninCreateAccountFragment().apply {
