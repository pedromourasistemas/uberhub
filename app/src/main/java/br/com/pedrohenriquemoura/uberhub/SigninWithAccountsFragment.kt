 ...
 * Use the [SigninWithAccountsFragment.newInstance] factory method to
...
class SigninWithAccountsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SigninWithAccountsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                SigninWithAccountsFragment().apply {
